...
def login(type, url):
    login_creds = {
        "email": 'mehdi@atlas-sales-agency.nl',
        "password": 'Atlaslions7'
    }

    svhk_login_creds = {
        "email": 'manager@atlassalesagency.nl',
        "password": '@tlas789'
    }
...
def upload_data(df,coll):
    mongo_uri = 'mongodb+srv://jasonrht:GnRnJ9825!@atlas-leaderboards.fkbpo.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
